    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.disable()).csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(antMatcher("/api/teachers/teacher/*")).permitAll()
                .requestMatchers(antMatcher("/api/students/create")).hasRole("ADMIN")
                .requestMatchers(antMatcher("/api/classes/create")).hasRole("ADMIN")
                .requestMatchers(antMatcher("/api/classes/teacherSchedules/*")).hasRole("TEACHER")
                .requestMatchers(antMatcher("/api/classes/studentClasses/*")).hasRole("STUDENT")
                .requestMatchers(antMatcher("/api/classSchedules/getClassSchedulesByClassId/*")).permitAll()
                ...
                .requestMatchers(antMatcher("/api/classSchedules/create")).hasRole("ADMIN")
                ...
                .requestMatchers(antMatcher("/api/teachers/teacher/inscriptions/*")).permitAll()
                .requestMatchers(antMatcher("/api/classes")).permitAll()
                .requestMatchers(antMatcher("/api/schedules")).permitAll()
                .requestMatchers(antMatcher("/api/classSchedules")).permitAll()
